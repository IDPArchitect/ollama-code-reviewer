...
async function checkHealth() {
    try {
        ...
        const ollamaHealthResponse = await axios_1.default.get(ollamaHealthUrl);
        ...
        if (process.env.OPENAI_API_KEY) {
            const openAIHealthResponse = await axios_1.default.get("https://api.openai.com/v1/models", {
                headers: {
