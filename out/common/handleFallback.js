...
exports.default = handleFallback;
...
async function handleFallback(prompt) {
    ...
    // If all fallbacks fail, show an error message to the user
    vscode.window.showErrorMessage("All fallback attempts failed. Please check your network and try again.");
    throw new Error("Fallback processing failed for all AI communicators.");
}
